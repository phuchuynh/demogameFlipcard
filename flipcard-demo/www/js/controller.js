/**
 * Created by phuch on 8/5/2016.
 */

gameCard.controller('GameCtrl', function GameCtrl($scope, $state, game, CacheService) {
...
gameCard.controller('MainCtrl', function MainCtrl($scope, $state, game, CacheService) {
